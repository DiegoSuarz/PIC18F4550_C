...
void lcd_send_data (unsigned char data)
{
 ...
 I2C_Write_Data(data_u|0x0D);
 I2C_Write_Data(data_u|0x09);

 I2C_Write_Data (data_l|0x0D);
 I2C_Write_Data (data_l|0x09);
...
void lcd_send_cmd (unsigned char data)
{
 ...
 I2C_Write_Data(data_u|0x0C);
 I2C_Write_Data(data_u|0x08);

 I2C_Write_Data(data_l|0x0C);
 I2C_Write_Data(data_l|0x08);
