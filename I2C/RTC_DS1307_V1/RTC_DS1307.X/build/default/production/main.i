...
int main(void) {
    ...
    Lcd_Init();
    Lcd_Cmd(12);
    I2C_Init_Master(100000,0);

    ConfiRegRTC(0xD0,data.segundos,reg_Segundos);
    ConfiRegRTC(0xD0,data.minutos,reg_min);
    ConfiRegRTC(0xD0,data.horas,reg_horas);
    ConfiRegRTC(0xD0,data.dates,reg_dates);
    ConfiRegRTC(0xD0,data.dias,reg_dias);
    ConfiRegRTC(0xD0,data.meses,reg_meses);
    ConfiRegRTC(0xD0,data.years,reg_years);
