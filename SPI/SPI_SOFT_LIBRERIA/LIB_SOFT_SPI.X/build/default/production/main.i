...
int main(void) {
    ...
    PORTDbits.RD3 = 0;
    SPI_SOFT_Tx(0b00000110);
    PORTDbits.RD3 = 1;
    _delay((unsigned long)((10)*(48000000UL/4000.0)));

    PORTDbits.RD3 = 0;
    SPI_SOFT_Tx(0b00000010);
    ...
    dato=SPI_SOFT_Rx();
    LATB=dato;
    _delay((unsigned long)((600)*(48000000UL/4000.0)));
    dato1=SPI_SOFT_Rx();
    LATB=dato1;
    PORTDbits.RD3 = 1;
...
void SPI_SOFT_Tx(uint8_t dato){
    ...
    for(uint8_t i=0;i<8;i++){
        ...
        if((dato<<i)&0x80)PORTDbits.RD1=1; else PORTDbits.RD1=0;
        PORTDbits.RD2 =1;
    }
